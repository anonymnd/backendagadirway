          ...
          <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
			<form action="#" class="request-form ftco-animate">
				...
				<div class="d-flex">
					<div class="form-group">
						<label for="" class="label">Station départ</label>
						<input type="text" class="form-control" placeholder="num bus, station, rue">
					</div>
					<div class="form-group">
						<label for="" class="label">Station arrivée</label>
						<input type="text" class="form-control" placeholder="num bus, station, rue">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<select class="form-control" id="departureOption" onchange="toggleDateTimeInput()">
						<option value="now">Partir maintenant</option>
						<option value="schedule">Partir le</option>
					</select>
				</div>
			
				<!-- Date and Time Picker (Hidden by default) -->
			...
			<script>
				function toggleDateTimeInput() {
					...
					// Show date/time input if "Partir le" is selected
